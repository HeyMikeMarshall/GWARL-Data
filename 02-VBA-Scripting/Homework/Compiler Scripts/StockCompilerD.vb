    ...
    For r = 2 To lrRaw
       ...
       'if raw ticker matches total ticker
        If ws.Cells(t, 9).Value = ws.Cells(r, 1).Value Then
            ...
            Application.StatusBar = "Processing " & Round((r / lrRaw * 100), 0) & "% Sheet " & sWorked & " of " & sTotal
...
MsgBox("Processing Complete. " & rWorked & " records compiled. Time Elapsed: " & minElapsed)
